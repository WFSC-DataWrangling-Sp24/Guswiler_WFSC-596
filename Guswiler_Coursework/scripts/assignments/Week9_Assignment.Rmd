...
# installing {here} for use in .Rmd files to aid in navigating sub-directories
...
write_csv(dipodomys_mass,                           # save data frame to clean_data
          file = here("data_clean/dipodomys_mass.csv"))
...
ggsave(here("outputs/HFL_v_Mass.png"))       # save plot to outputs
...
ggsave(here("outputs/SubplotIndividuals_v_Mass.png"))  # save plot to outputs
```
...
download.file(url = "https://portal.edirepository.org/nis/dataviewer?packageid=knb-lter-pal.219.3&entityid=002f3893385f710df69eeebe893144ff",
              destfile = here("data_raw/adelie.csv"))
...
download.file(url = "https://portal.edirepository.org/nis/dataviewer?packageid=knb-lter-pal.220.3&entityid=e03b43c924f226486f2f0ab6709d2381",
              destfile = here("data_raw/gentoo.csv"))
...
download.file(url = "https://portal.edirepository.org/nis/dataviewer?packageid=knb-lter-pal.221.2&entityid=fe853aa8f7a59aa84cdd3197619ef462",
              destfile = here("data_raw/chinstrap.csv"))
```
...
penguins <- penguins
adelie <- read_csv(here("data_raw/adelie.csv"))
chinstrap <- read_csv(here("data_raw/chinstrap.csv"))
gentoo <- read_csv(here("data_raw/gentoo.csv"))
...
#3d
write_csv(pengu, here("data_clean/pengu.csv"))
```
