...
Many functions can take multiple arguments. For example, let's use a function to round `weight_kg` to one decimal place.
...
It is common to forget this when dealing with functions and expect the function to have changed the value of the variable. However, if we look at `weight_kg`, we see that it hasn't been rounded.
