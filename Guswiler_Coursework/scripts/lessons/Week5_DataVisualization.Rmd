...
download.file("https://ndownloader.figshare.com/files/5629542",
              here("data_raw/ACACIA_DREPANOLOBIUM_SURVEY.txt"))
download.file("https://ndownloader.figshare.com/files/5629536",
              here("data_raw/TREE.txt"))
```
...
```{r}
acacia <- read_tsv(here("data_raw/ACACIA_DREPANOLOBIUM_SURVEY.txt"))
```
...
ggsave(here("outputs/acacia_circ_v_height_scatter.png"),
       scatterplot,
       height = 5, width = 5)
```
