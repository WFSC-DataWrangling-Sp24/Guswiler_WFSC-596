...
[x] Project is in a GitHub repository.

[x] Project is fully computationally reproducible, meaning your instructor can clone your GitHub repo, open the RStudio Project, and successfully recreate your project without having to make any changes to the code.

[x] Project contains code or material from the appropriate number of weeks, as described below.

[x] RMarkdown file contains written descriptions of the tasks being performed.
...
[x] Week 1: Spreadsheets NEED TO ADD SECTION FOR CLEANING UP DATA AND RESAVING\
[x] Week 2: Intro to R default\
[x] Week 3: Data Tables and Pipes\
[x] Week 4: Groups and Joins\
[x] Week 5: Data Visualization\
[x] Week 6: Tidy Data\
[ ] Week 7: Dates and Strings\
[x] Week 8: Problem Decomposition default\
[x] Week 9: Reproducibility default\
[x] Week 10: Functions \*need 1/3\*\
[x] Week 11: Making Choices \*need 1/3\*\
[ ] Week 12: Iteration \*need 1/3\*\
...
[To make both of our lives easier, it will really help if you explicitly note somewhere in the final project where content from your required number of weeks is present in your project.]{.underline}
...
Or, another way that makes the most sense for you!
...
1.  [You must include some type of data visualization in your project (Week 5)]{.underline}
