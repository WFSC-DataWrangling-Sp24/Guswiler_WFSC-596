...
Create visualizations for the data separated only by age category.
...
The results indicate that the null hypothesis is to be rejected, TOR test phase performance and time spent exploring differ between young and old rats.
