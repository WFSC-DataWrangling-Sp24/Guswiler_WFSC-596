...
This code focuses on cleaning up the original data that is saved in four different .csv files, creating columns with calculations based on existing data, visualizing the data, and running analyses to compare performance among groups on this task.
